...
$('.client_one').click(function(){
$('.menu_clients li:nth-child(2)').css('display', 'none');
$('.menu_clients li:nth-child(3)').css('display', 'none');
$('.menu_clients li:nth-child(1)').css('display', 'inline-block');
$('.client_main').removeClass('client_active');
$('.client_one').addClass('client_active');
});

$('.client_two').click(function(){
$('.menu_clients li:nth-child(1)').css('display', 'none');
$('.menu_clients li:nth-child(3)').css('display', 'none');
$('.menu_clients li:nth-child(2)').css('display', 'inline-block');
$('.client_main').removeClass('client_active');
$('.client_two').addClass('client_active');
});

$('.client_three').click(function(){
$('.menu_clients li:nth-child(1)').css('display', 'none');
$('.menu_clients li:nth-child(2)').css('display', 'none');
$('.menu_clients li:nth-child(3)').css('display', 'inline-block');
$('.client_main').removeClass('client_active');
$('.client_three').addClass('client_active');
});
});
/**
 * main.js
